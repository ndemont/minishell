...
#    Updated: 2021/05/19 12:18:29 by ndemont          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
=======
	lexer/nodes.c lexer/tokens.c lexer/quotes.c lexer/variables.c lexer/odd_chars.c free/free_datas.c free/free_tree.c free/free.c ast/exec_tree.c ast/exec_builtin.c ast/exec_binary.c ast/redirection_node.c ast/tree.c ast/semicolon_node.c ast/pipe_node.c\
>>>>>>> Lexer norme
	...
	builtins/export.c builtins/export_list_actualization.c builtins/export_list_actualization_2.c builtins/export_args_conformity.c builtins/export_printer.c)
